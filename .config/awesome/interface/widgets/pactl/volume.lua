...
local pactl = require("interface.widgets.pactl.pactl")
local utils = require("interface.widgets.pactl.utils")

local widget_types = {
	icon_and_text = require("interface.widgets.volume-widget.widgets.icon-and-text-widget"),
	icon = require("interface.widgets.volume-widget.widgets.icon-widget"),
	arc = require("interface.widgets.volume-widget.widgets.arc-widget"),
	horizontal_bar = require("interface.widgets.volume-widget.widgets.horizontal-bar-widget"),
	vertical_bar = require("interface.widgets.volume-widget.widgets.vertical-bar-widget"),
}
local volume = {}
...
local function worker(user_args)
	...
	local widget_type = vertical_bar or args.widget_type or vertical_bar
	...
	if widget_types[widget_type] == nil then
		volume.widget = widget_types["arc"].get_widget(args.vwrtical_bar_args)
	else
